...
class JobView {
    ...
    fun generateHtmlPage(jobs: List<Job>, statistics: JobStatistics? = null): String {
        ...
        return buildString {
            ...
            appendLine("        .stat-card { background: #4a5568; color: white; padding: 20px; border-radius: 15px; text-align: center; box-shadow: 0 4px 15px rgba(0,0,0,0.1); }")
            ...
            appendLine("            </div>")
            appendLine("            <div style=\"background: #f7fafc; border-radius: 15px; padding: 20px; margin: 20px 0; text-align: center;\">")
